...
from deep_image_matting.Combined_Dataset.Training_set.Composition_code_revised import do_composite
from deep_image_matting.Combined_Dataset.Test_set.Composition_code_revised import do_composite_test
